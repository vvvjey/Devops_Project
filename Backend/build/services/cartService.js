...
var getProductsById = function getProductsById(data) {
...
var addProductToCart = function addProductToCart(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var productDetail, isExistedProductInCart;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 11:
            isExistedProductInCart = _context2.sent;
          ...
          case 18:
            ...
            _context2.next = 22;
            return isExistedProductInCart.save();
          case 22:
            resolve({
              errCode: 0,
...
var deleteProductInCart = function deleteProductInCart(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var isExistedProductInCart;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 8:
            isExistedProductInCart = _context3.sent;
            if (isExistedProductInCart) {
              _context3.next = 13;
              break;
            }
          ...
          case 13:
            _context3.next = 15;
            return isExistedProductInCart.destroy();
          case 15:
            resolve({
              errCode: 0,
...
var modifyProductQuantityInCart = function modifyProductQuantityInCart(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 8:
            isExistedProductInCart = _context4.sent;
            if (isExistedProductInCart) {
              _context4.next = 13;
              break;
            }
...
module.exports = {
  ...
  modifyProductQuantityInCart: modifyProductQuantityInCart
};